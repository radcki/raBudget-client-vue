...
function createTransactionSchedule (budgetId: number, data: TransactionSchedule) {
  ...
  return apiHandler.fetchAuthorized<any>(`${process.env.VUE_APP_APIURL}/budgets/${budgetId}/transactionSchedules`, requestOptions)
}
...
function updateTransactionSchedule (budgetId: number, data: TransactionSchedule) {
  ...
  return apiHandler.fetchAuthorized<any>(`${process.env.VUE_APP_APIURL}/budgets/${budgetId}/transactionSchedules/${data.transactionScheduleId}`, requestOptions)
}
...
function deleteTransactionSchedule (budgetId: number, id: number) {
  ...
  return apiHandler.fetchAuthorized<any>(`${process.env.VUE_APP_APIURL}/budgets/${budgetId}/transactionSchedules/${id}`, requestOptions)
}
...
function listTransactionSchedules (budgetId, startDate, endDate) {
  ...
  return apiHandler.fetchAuthorized<TransactionSchedule[]>(`${process.env.VUE_APP_APIURL}/budgets/${budgetId}/transactionSchedules/filter`, requestOptions)
}
...
function getTransactionSchedule (budgetId, transactionScheduleId) {
  ...
  return apiHandler.fetchAuthorized<TransactionSchedule>(`${process.env.VUE_APP_APIURL}/budgets/${budgetId}/transactionSchedules/` + transactionScheduleId, requestOptions)
}
...
function listClosestOccurrences (budgetId, endDate) {
  ...
  var url = new URL(`${process.env.VUE_APP_APIURL}/budgets/${budgetId}/transactionSchedules/closest-transactions`, document.location.toString())
